...
raw <- raw %>% mutate(d=ifelse(state%in%c('KoreaSouth','Japan','Singapore','China')|scope=='china',1,0)) %>% select(-peak,-gap)
...
keras::save_model_hdf5(model,paste0('/Users/wenrurumon/Documents/posdoc/wuhan/model/kouzhao.model'),overwrite = TRUE,include_optimizer = TRUE)

###################################
# Validation
###################################

# model <- keras::load_model_hdf5(paste0('/Users/wenrurumon/Documents/posdoc/wuhan/model/kouzhao.model'))
