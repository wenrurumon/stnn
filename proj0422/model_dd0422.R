...
for(i in 1:5){
  keras::save_model_hdf5(rlt.model2[[i]]$model,paste0('/Users/wenrurumon/Documents/posdoc/wuhan/model/model_d_',i,'.model'),overwrite = TRUE,include_optimizer = TRUE)
}
...
for(i in 1:5){
  keras::save_model_hdf5(rlt.model3[[i]],paste0('/Users/wenrurumon/Documents/posdoc/wuhan/model/model_m_',i,'.model'),overwrite = TRUE,include_optimizer = TRUE)
}
save(raw,file='raw0225.rda')
...
model.d <- lapply(1:5,function(i){
  keras::load_model_hdf5(paste0('/Users/wenrurumon/Documents/posdoc/wuhan/model/model_d_',
                                i,'.model'))
})
model.m <- lapply(1:5,function(i){
  keras::load_model_hdf5(paste0('/Users/wenrurumon/Documents/posdoc/wuhan/model/model_m_',
                                i,'.model'))
})
