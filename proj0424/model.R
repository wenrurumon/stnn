...
for(i in 1:5){
  keras::save_model_hdf5(rlt.model2[[i]]$model,paste0('/Users/wenrurumon/Documents/posdoc/wuhan/model/model0424_d_',i,'.model'),overwrite = TRUE,include_optimizer = TRUE)
}
...
for(i in 1:5){
  keras::save_model_hdf5(rlt.model3[[i]],paste0('/Users/wenrurumon/Documents/posdoc/wuhan/model/model0424_m_',i,'.model'),overwrite = TRUE,include_optimizer = TRUE)
}
save(raw,file='raw0424.rda')
...
model.d <- lapply(1:5,function(i){
  keras::load_model_hdf5(paste0('/Users/wenrurumon/Documents/posdoc/wuhan/model/model0424_d_',
                                i,'.model'))
})
model.m <- lapply(1:5,function(i){
  keras::load_model_hdf5(paste0('/Users/wenrurumon/Documents/posdoc/wuhan/model/model0424_m_',
                                i,'.model'))
})

# K <- 'global confirmed US'
rlt <- lapply(unique(filter(raw,state=='US'|scope=='us')$key),function(K){
  rlt <- list()
  print(K)
  for(j in 1:3){
...
sapply(rlt[[1]],function(x){x$d}) %>% plot.ts
